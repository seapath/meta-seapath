...
do_install:append() {
    ...
    install -m 644 ${UNPACKDIR}/create-var-run-resource-agents.service \
        ${D}/${systemd_unitdir}/system/create-var-run-resource-agents.service
    install -m 644 ${UNPACKDIR}/pacemaker.service \
    ...
    install --mode=0755 ${UNPACKDIR}/alert_smtp.sh ${D}${localstatedir}/lib/pacemaker/alert_smtp.sh
    install --mode=0755 ${UNPACKDIR}/alert_snmp.sh ${D}${localstatedir}/lib/pacemaker/alert_snmp.sh
}
