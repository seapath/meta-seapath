...
LIC_FILES_CHKSUM = "file://COPYING-LGPL2.1;md5=fbc093901857fcd118f065f900982c24 \
                    ...
                    file://COPYING;md5=0872e55714dd50a5ee82e8f26afe15c7 \
"
inherit autotools cmake pkgconfig python3native python3-dir systemd useradd
...
SRC_URI = "http://download.ceph.com/tarballs/ceph-${PV}.tar.gz \
           ...
           file://0001-ceph-19.2.2-rocksdb-cstdint.patch \
           file://0004-cmake-remove-Boost-system-linkage-for-boost-1.89.patch \
           file://0005-common-fix-TrackedOp-intrusive_ptr-compatibility-wit.patch \
           file://0006-Fix-boost-api-break.patch \
           file://0001-pybind-fix-callback-function-type-compatibility-for-.patch \
           file://0009-fix-cross-compilation-with-python-cython-modules.patch \
"

SRC_URI[sha256sum] = "de779aa0141839388bb201e0a9d622b8433982e1c4d7bfc3ac6117b763972542"

DEPENDS = "boost bzip2 curl cryptsetup expat gperf-native \
           keyutils libaio libnbd libnl lmdb lua lz4 \
...
do_configure:prepend () {
    ...
    echo "set( XXH_NO_INLINE_HINTS 1 )" >> ${WORKDIR}/toolchain.cmake
}
...
do_install:append () {
    ...
    find ${D} -name SOURCES.txt | xargs sed -i -e 's:${UNPACKDIR}::'
