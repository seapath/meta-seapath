...
# devtool add --npm-dev https://github.com/seapath/cockpit-cluster-dashboard.git -B main
...
SRC_URI = " \
    git://github.com/seapath/cockpit-cluster-dashboard.git;protocol=https;branch=main \
    npmsw://${THISDIR}/${BPN}/npm-shrinkwrap.json;dev=1 \
    "

SRCREV = "9d334048ab88c589f0b6611235e96047da64db2e"
